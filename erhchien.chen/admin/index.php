...
$empty_product = (object)[
	"name"=>"Durin",
	"price"=>"12.99",
	"description"=>"I only know Zelda",
	"category"=>"Jelly",
	"thumbnail"=>"choco-mikasa.jpeg",
	"images"=>"choco-mikasa.jpeg",
	"quantity"=>"23"
];
...
function showProductPage($o){
    ...
    <form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
        ...
        <div>
            ...
            <input name="product-quantity" id="product-quantity" type="Number" min="0" max="1000" step="1" placeholder="Enter the Product Quantity" value="$o->quantity" class="form-input">
        </div>
        <div>
